letdata = {
    ...
    "global": {
        ...
        "M_Customer_Code_Schema": [],// 12
        "M_Activity_Schema": [ // 13
        ...
        "M_NP_Material_Schema": [],// 14
        "M_Attendance_Schema": [// 15
            {
                "attendance_id": 132,
                "attendance_code": "C",
        ...
        "T_Attendance_Schema": [] // 28
    },
    "harvest_clerk": {
        "T_Harvesting_Plan_Schema": [], // 29
        "Laporan_Panen_Kemarin": [], // 30
        "Laporan_Panen_Kemarin_Persons": [], // 31
        "Laporan_Restan": [], // 32
        "T_ABW_Schema": [] // 33
    }
}