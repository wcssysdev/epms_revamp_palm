...
class AuthRepositoryImpl implements AuthRepository{// IMPLEMENTASI dari INTERFACE  - JANGAN DI HAPUS
  ...
  Future<bool> login(String username, String password, {String? ipAddress}) async {
    ...
    await masterDataRepository.saveHarvestMethods(masterDataGlobal[AppConstants.mHarvestingMethodSchema]);
    await masterDataRepository.saveEmployee(masterDataGlobal[AppConstants.mEmployeeSchema]);
